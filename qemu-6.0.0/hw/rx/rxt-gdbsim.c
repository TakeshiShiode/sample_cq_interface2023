...
typedef struct RxtGdbSimMachineClass RxtGdbSimMachineClass;

struct RxtGdbSimMachineState {
    /*< private >*/
    MachineState parent_obj;
    /*< public >*/
    RX62TState mcu;
};
typedef struct RxtGdbSimMachineState RxtGdbSimMachineState;

#define TYPE_RXT_GDBSIM_MACHINE MACHINE_TYPE_NAME("rx62t-common")

DECLARE_OBJ_CHECKERS(RxtGdbSimMachineState, RxtGdbSimMachineClass,
                     RXT_GDBSIM_MACHINE, TYPE_RXT_GDBSIM_MACHINE)
...
static void rx_gdbsim_init(MachineState *machine)
{
    ...
    RxtGdbSimMachineState *s = RXT_GDBSIM_MACHINE(machine);
    RxtGdbSimMachineClass *rxc = RXT_GDBSIM_MACHINE_GET_CLASS(machine);
...
{
    RxtGdbSimMachineClass *rxc = RXT_GDBSIM_MACHINE_CLASS(oc);
    MachineClass *mc = MACHINE_CLASS(oc);
...
static const TypeInfo rxt_gdbsim_types[] = {
	{
        .name           = MACHINE_TYPE_NAME("gdbsim-rx62t"),
        .parent         = TYPE_RXT_GDBSIM_MACHINE,
        .class_init     = rx62taadfh_class_init,
    },{
        .name           = TYPE_RXT_GDBSIM_MACHINE,
        .parent         = TYPE_MACHINE,
        .instance_size  = sizeof(RxtGdbSimMachineState),
        .class_size     = sizeof(RxtGdbSimMachineClass),
        .class_init     = rx_gdbsim_class_init,
        .abstract       = true,
     }
};

DEFINE_TYPES(rxt_gdbsim_types)
