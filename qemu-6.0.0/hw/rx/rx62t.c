...
/*
 * RX62T Internal Memory
 */
#define RX62T_IRAM_BASE     0x00000000
#define RX62T_DFLASH_BASE   0x00100000
#define RX62T_CFLASH_BASE   0xfffC0000


/*
 * RX62T Peripheral Address
 * See users manual section 5
 */
#define RX62T_ICU_BASE  0x00087000
#define RX62T_TMR_BASE  0x00088200
#define RX62T_CMT_BASE  0x00088000
#define RX62T_SCI_BASE  0x00088240
#define RX62T_MTU0BASE 0x000C1300
#define RX62T_MTU1BASE 0x000C1380
#define RX62T_MTU2BASE 0x000C1400
#define RX62T_MTU34BASE 0x000C1200
#define RX62T_MTU5BASE 0x000C1C80
#define RX62T_MTU67BASE 0x000C1A00
#define RX62T_S12ADBASE 0x00089000
#define RX62T_IOPORTBASE 0x0008C000
#define RX62T_KEYTESTBASE 	0x000FFD00

/*
 * RX62T Peripheral IRQ
 * See users manual section 11
 */
#define RX62T_TMR_IRQ   174
#define RX62T_CMT_IRQ   28
#define RX62T_SCI_IRQ   214

#define RX62T_XTAL_MIN_HZ  (8 * 1000 * 1000)
#define RX62T_XTAL_MAX_HZ (14 * 1000 * 1000)
#define RX62T_PCLK_MAX_HZ (50 * 1000 * 1000)
...
typedef struct RX62TClass RX62TClass;

DECLARE_CLASS_CHECKERS(RX62TClass, RX62T_MCU,
                       TYPE_RX62T_MCU)
...
static void register_icu(RX62TState *s)
{
    int i;
    SysBusDevice *icu;
    ...
    sysbus_mmio_map(SYS_BUS_DEVICE(icu), 0, RX62T_ICU_BASE);
}

static void register_tmr(RX62TState *s, int unit)
{
    SysBusDevice *tmr;
    int i, irqbase;
    ...
    irqbase = RX62T_TMR_IRQ + TMR_NR_IRQ * unit;
    for (i = 0; i < TMR_NR_IRQ; i++) {
        sysbus_connect_irq(tmr, i, s->irq[irqbase + i]);
    }
    sysbus_mmio_map(tmr, 0, RX62T_TMR_BASE + unit * 0x10);
}

static void register_cmt(RX62TState *s, int unit)
{
    SysBusDevice *cmt;
    int i, irqbase;
    ...
    irqbase = RX62T_CMT_IRQ + CMT_NR_IRQ * unit;
    for (i = 0; i < CMT_NR_IRQ; i++) {
        sysbus_connect_irq(cmt, i, s->irq[irqbase + i]);
    }
    sysbus_mmio_map(cmt, 0, RX62T_CMT_BASE + unit * 0x10);
}

static void register_sci(RX62TState *s, int unit)
{
    SysBusDevice *sci;
    int i, irqbase;
    ...
    irqbase = RX62T_SCI_IRQ + SCI_NR_IRQ * unit;
    for (i = 0; i < SCI_NR_IRQ; i++) {
        sysbus_connect_irq(sci, i, s->irq[irqbase + i]);
    }
    sysbus_mmio_map(sci, 0, RX62T_SCI_BASE + unit * 0x08);
}
...
static void register_mtu1(RX62TState *s, int unit)
{
    SysBusDevice *mtu1;
    int i, irqbase;
    ...
    qdev_prop_set_uint64(DEVICE(mtu1), "input-freq", RX62T_PCLK);
    ...
    sysbus_mmio_map(mtu1, 0, RX62T_MTU1BASE);

}

static void register_mtu2(RX62TState *s, int unit)
{
    SysBusDevice *mtu2;
    int i, irqbase;
    ...
    qdev_prop_set_uint64(DEVICE(mtu2), "input-freq", RX62T_PCLK);
    ...
    sysbus_mmio_map(mtu2, 0, RX62T_MTU2BASE);
}


static void register_mtu34(RX62TState *s, int unit)
{
    SysBusDevice *mtu34;
    int i, irqbase;
    ...
    qdev_prop_set_uint64(DEVICE(mtu34), "input-freq", RX62T_PCLK);
    ...
    sysbus_mmio_map(mtu34, 0, RX62T_MTU34BASE);

}

static void register_s12ad(RX62TState *s, int unit)
{
    SysBusDevice *s12ad;
    int i, irqbase;
    ...
    qdev_prop_set_uint64(DEVICE(s12ad), "input-freq", RX62T_PCLK);
    ...
    sysbus_mmio_map(s12ad, 0, RX62T_S12ADBASE);
}
...
static void register_keytest(RX62TState *s, int unit)
{
    ...
    sysbus_mmio_map(keytest, 0, RX62T_KEYTESTBASE);
}
...
static void rx62t_realize(DeviceState *dev, Error **errp)
{
    ...
    /* XTAL range: 8-14 MHz */
    if (s->xtal_freq_hz < RX62T_XTAL_MIN_HZ
            || s->xtal_freq_hz > RX62T_XTAL_MAX_HZ) {
    ...
    /* PCLK range: 8-50 MHz */
    assert(s->pclk_freq_hz <= RX62T_PCLK_MAX_HZ);
    ...
    memory_region_add_subregion(s->sysmem, RX62T_CFLASH_BASE, &s->c_flash);
...
static Property rx62t_properties[] = {
    DEFINE_PROP_LINK("main-bus", RX62TState, sysmem, TYPE_MEMORY_REGION,
                     MemoryRegion *),
    DEFINE_PROP_BOOL("load-kernel", RX62TState, kernel, false),
    DEFINE_PROP_UINT32("xtal-frequency-hz", RX62TState, xtal_freq_hz, 0),
    DEFINE_PROP_END_OF_LIST(),
};

static void rx62t_class_init(ObjectClass *klass, void *data)
{
    DeviceClass *dc = DEVICE_CLASS(klass);

    dc->realize = rx62t_realize;
    device_class_set_props(dc, rx62t_properties);
}
...
static void r5f562taddfh_class_init(ObjectClass *oc, void *data)
{
    ...
    rxc->ram_size =16 * KiB;
    rxc->rom_flash_size = 256 * KiB;
    rxc->data_flash_size = 32 * KiB;
};

static const TypeInfo rx62t_types[] = {
	{
        .name           = TYPE_R5F562TADDFH_MCU,
        .parent         = TYPE_RX62T_MCU,
        .class_init     = r5f562taddfh_class_init,
    }, {
        .name           = TYPE_RX62T_MCU,
        .parent         = TYPE_DEVICE,
        .instance_size  = sizeof(RX62TState),
        .class_size     = sizeof(RX62TClass),
        .class_init     = rx62t_class_init,
        .abstract       = true,
     }
};

DEFINE_TYPES(rx62t_types)
